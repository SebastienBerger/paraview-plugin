...
void vtkBumpMapper::BoundPoints(vtkIdType nbPoints, vtkIdType* pointsIds, vtkDoubleArray* IT, vtkIdType * result)
{
    result[0] = -1;
    result[1] = -1;
...
void vtkBumpMapper::WeightedAverage2Points(vtkIdType * AB, vtkPolyData* input, double * C)
{
